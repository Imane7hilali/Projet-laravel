...
<table class="table table-bordered " style="width:80%;position:absolute;left:12%;height:4em;" id="hotel_content" >
  <tr>
     ...
     <th width="140px" class="text-center">
       <a href="{{route('villa.create')}}" class="btn btn-success">
...
<tr>
   ...
   <td>{{ $value->city }}</td>
   <td>
      <a class="btn btn-info" href="{{route('villa.show',$value->id)}}">
         <i class="bi bi-microsoft" style="color:white"></i></a>
      <a class="btn btn-primary" href="{{route('villa.edit',$value->id)}}">
         <i class="bi bi-pencil"></i></a>
   {!! Form::open(['method' => 'DELETE','route' => ['villa.destroy',$value->id],'style'=>'display:inline']) !!}
